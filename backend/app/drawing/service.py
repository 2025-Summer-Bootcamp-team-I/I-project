...
PROMPT = (
    ...
    "  \"risk_score\": <0~5>,\n"
    "  \"drawing_score\": <0~5>,\n"
    "  \"drawingtest_result\": \"<최소 130자 이상. 다음 항목 반드시 포함:>\n"
    "    ① '이 그림은 Score X 예시와 유사합니다'라는 언급,\n"
    "    ② 숫자 배열·정확도·누락 여부 설명,\n"
    "    ③ 시침·분침 방향 및 중심 여부,\n"
    "    ④ 시간 해독 가능 여부 및 전체 평가\"\n"
    "}\n\n"
    ...
    "  \"risk_score\": 5,\n"
    "  \"drawing_score\": 5,\n"
    "  \"drawingtest_result\": \"이 그림은 Score 5 예시와 매우 유사합니다. "
    "숫자 1~12가 원 주변에 고르게 배열되어 있고, 시침은 정확히 11시를, 분침은 10분(2방향)을 향하며 모두 중심에서 출발했습니다. "
    "전체적으로 매우 깔끔하고, 시간 해독에 전혀 문제가 없어 정상 범주로 판단됩니다.\"\n"
    "}"
)
